...
class TestMainPage:
    ...
    @pytest.mark.smoke_test
    def test_positive_header_basket1_smoke(self, driver, url, setup):
    ...
    @pytest.mark.smoke_test
    def test_positive_building_advices1_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
        ...
        for url in urls:
            ...
            assert driver.current_url == url, f"Ожидалось {url}, но получено {driver.current_url}"

    @allure.title("TC 005 - Функционал блока 'Советы от профессионалов ремонта'")
    @pytest.mark.smoke_test
    def test_positive_building_advices2_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
        items = main_page.get_building_advices_section()
        urls = [item.get_attribute('href') for item in items]
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_back_call_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_building_advices_smoke(self, driver, url):
        main_page = MainPage(driver)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_catalog_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_delivery_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_email_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_lifting_smoke(self, driver, url):
        main_page = MainPage(driver)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_location_smoke(self, driver,url):
        main_page = MainPage(driver)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_new_in_stock_smoke(self, driver, url):
        main_page = MainPage(driver)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_payment_order_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_phone_number_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_price_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_reviews_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
    ...
    @pytest.mark.smoke_test
    def test_positive_footer_sale_smoke(self, driver, url):
        main_page = MainPage(driver)
        driver.get(url)
