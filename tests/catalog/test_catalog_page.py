...
class TestCatalogPage:
    ...
    @allure.title("001_positive_button_building_tools_smoke(catalog)")
    @pytest.mark.parametrize('link', [MAIN_PAGE_PROD_URL, MAIN_PAGE_STAGE_URL])
    @pytest.mark.smoke_test
    def test_001_positive_button_building_tools_smoke_catalog(self, driver, link, catalog_page_open):
